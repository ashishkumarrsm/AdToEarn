      ...
      <Dialog open={open} onClose={isClose} className="relative z-10">
        ...
        <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
          <div className="flex min-h-auto md:min-h-screen mt-20 md:mt-0 items-end justify-center p-4 text-center sm:items-center sm:p-0">
            <DialogPanel
              transition
              className="relative transform overflow-hidden rounded-lg bg-[#0b90c280] px-4 pb-4 pt-5 text-left shadow-xl transition-all data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in sm:my-8 sm:w-full sm:max-w-lg sm:p-6 data-[closed]:sm:translate-y-0 data-[closed]:sm:scale-95"
            >
                  ...
                  <div>
                      ...
                      <div className="mt-2.5">
                        <input
                          ...
                          className="block w-full rounded-md border-0 px-3.5 py-2 text-gray-300 bg-[#0b90c280] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-lg sm:leading-6"
                        />
                ...
                <div className="mt-6">
                  <div className="mt-5 sm:mt-6 sm:grid sm:grid-flow-row-dense sm:grid-cols-2 sm:gap-3">
                    ...
                    <button
                      ...
                      data-autofocus
                      onClick={isClose}
                      className="mt-3 inline-flex w-full bg-red-600 justify-center rounded-md bg-white px-3 py-2 text-lg font-semibold text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50 sm:col-start-1 sm:mt-0"
                    >
