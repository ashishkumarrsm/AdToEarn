    ...
    <div className="bg-[#0b90c280] p-4">
      <div className="">
        ...
        <input
          ...
          className="block w-[50vh] px-2 py-2 rounded-sm bg-[#0b90c280] border-0 text-gray-200 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-lg sm:leading-6"
        />
      </div>
      <table className="z-10 mt-6 w-full whitespace-nowrap text-left">
        ...
        <thead className="border-b border-white/10 text-base leading-6 text-white">
          <tr>
            <th
              scope="col"
              className="py-2 pl-4 font-medium sm:pl-6 lg:pl-8"
            >
              ID
            </th>
            <th
              scope="col"
              className="hidden py-2 pl-0 pr-8 font-medium sm:table-cell"
            >
             Level
            </th>
            <th
            ...
            <th
              scope="col"
              className="hidden py-2 pl-0 pr-4 font-medium sm:table-cell sm:pr-6 lg:pr-8"
            >
              Action
            </th>
          </tr>
