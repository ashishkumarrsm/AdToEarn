    ...
    <Dialog open={openModel} onClose={modelClose} className="relative z-50">
      ...
      <div className="fixed inset-0 z-10 w-screen overflow-y-auto">
        <div className="flex items-end justify-center min-h-full p-4 text-center sm:items-center sm:p-0">
          <DialogPanel
            transition
            className="relative transform  rounded-lg text-gray-100 bg-[#0b90c280] border px-4 pb-4 pt-5 text-left shadow-xl transition-all data-[closed]:translate-y-4 data-[closed]:opacity-0 data-[enter]:duration-300 data-[leave]:duration-200 data-[enter]:ease-out data-[leave]:ease-in sm:my-8 sm:w-full sm:max-w-lg sm:p-6 data-[closed]:sm:translate-y-0 data-[closed]:sm:scale-95"
          >
            <div>
              <div className="p-5 relative">
                ...
                >
                  <div class="group flex  cursor-pointer items-center justify-center mb-2 bg-[#0f4558] p-3 h-16 w-16 rounded-full">
                    <div class="space-y-2">
                  ...
                  <div className="w-full">
                    <form onSubmit={handleSubmit} className="space-y-4">
                      <div className="grid grid-cols-1 sm:grid-cols-1">
                        <div className="mb-4 ">
                          <label className="block text-base ">User name</label>
                          <input
                            type="text"
                            name="text"
                            className="block w-full px-3 py-2 mt-1 bg-[#0b90c280] border text-gray-200 border-white/50 rounded-sm shadow-sm"
                        ...
                        <div className="mb-4">
                          ...
                          <input
                            ...
                            type="text"
                            name="description"
                            className="block w-full px-3 py-2 mt-1 text-base bg-[#0b90c280] border text-gray-200 border-white/50 rounded-sm shadow-sm focus:ring-opacity-50"
                      ...
                      <div className="flex w-full gap-4">
                        <button
                          type="button"
                          className="w-1/2 px-4 py-2 text-lg text-white bg-[#0b90c280] border rounded shadow hover:bg-[#0b90c280] focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-opacity-50"
                          onClick={() =>
