    ...
    <div className="bg-[#0b90c280] p-4 ">
      <div className="">
        ...
        <input
          ...
          className="block w-[50vh] px-2 py-1 rounded-md border-0 text-gray-200 bg-[#1a8ab280] shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-lg sm:leading-6"
        />
      </div>
        ...
        <div className="overflow-x-auto ">
          <div className="inline-block min-w-full py-2 align-middle ">
            <table className="z-10 mt-6 w-full whitespace-nowrap text-left">
              <thead className="border-b border-white/10 text-base bg-black leading-6 text-white">
                <tr>
