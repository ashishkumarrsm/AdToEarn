        ...
        <div className="px-6 py-16 mx-auto max-w-7xl lg:px-8">
          <div className="relative bg-white shadow-xl rounded-lg overflow-hidden">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3">
              {/* Contact information */}
              <div className="relative px-6 py-10 overflow-hidden bg-orange-500 sm:px-10 xl:p-12">
                <div
                  aria-hidden="true"
                ...
                <p className="max-w-3xl mt-6 text-base text-orange-50">
                ...
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-orange-50">
                    <PhoneIcon
                      aria-hidden="true"
                      className="text-orange-200 size-6 shrink-0"
                    />
              ...
              <div className="px-6 py-10 sm:px-10 lg:col-span-2 xl:p-12">
                ...
                >
                  <div>
                    ...
                    <div className="mt-1">
                      <input
                        ...
                        className="block w-full px-4 py-3 text-gray-900 border border-gray-300 rounded-md shadow-sm focus:border-orange-500 focus:ring-orange-500"
                      />
                    </div>
                  </div>
                  <div>
                  ...
                  <div className="sm:col-span-2 sm:flex sm:justify-end">
                    <button
                      type="submit"
                      className="mt-4 bg-gradient-to-r from-orange-400 to-orange-500 text-white py-1 px-1 rounded-full flex items-center gap-2 hover:from-orange-500 hover:to-orange-600 transition-all duration-300 shadow-lg"
                    >
