...
export default function UserTopup() {
  ...
  <UserTopupModel openModel={openModel} modelClose={modelClose}/>
      ...
      <div className="p-4 m-3  bg-gray-800">
        <div className="flex-col items-start justify-between w-full mb-3 lg:flex sm:flex md:flex-row md:items-center lg:pl-3">
          ...
          <div className="mt-3 md:mt-0  ">
            <div className="relative flex max-w-full gap-3 md:gap-5 md:max-w-lg">
              <div className="relative ">
                <input
                     className="w-full h-10 py-2 pl-3 text-lg transition duration-200 border rounded shadow-sm text-gray-100 bg-gray-800 pr-11 placeholder:text-slate-100  border-slate-200 ease focus:outline-none focus:border-slate-400 hover:border-slate-100 focus:shadow-md"
                  placeholder="Search..."
                />
                <button
              ...
              <button
                type="button"
                onClick={() => setOpenModel(true)}
                className="px-3 py-2 text-base font-semibold text-center  rounded shadow-sm text-gray-100 bg-gray-800 hover:bg-[#27596b80] hover:text-[#ffeded] focus:outline-none"
              >
                Re-Top-Up 
              </button>
            </div>
                ...
                {singletopup?.length > 0 ? (
                  singletopup
                    ...
                    .map((item, index) => (
                      <tr
                        key={index}
                        className="text-gray-900 even:bg-gray-800 even:text-gray-900"
                      >
