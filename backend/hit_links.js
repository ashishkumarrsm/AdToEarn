...
const urls = [
   "https://api.teirrax.com/api/v1/referral/roi"
    "https://api.teirrax.com/api/v1/referral/commission/check"
    "https://api.teirrax.com/api/v1/referral/check"
    "https://api.teirrax.com/api/v1/reward"
];
